...
\centering
    \includegraphics[width=100mm]{./edges.png}
\end{frame}

\subsection{Canny Edge detection}
\begin{frame}{Canny}{Edge Detection}
\centering
    \includegraphics[width=100mm]{./canny_edge.png}
...
\centering
    \includegraphics[width=50mm]{./contours.png}

\end{frame}
\subsection{Bounding Box}
\begin{frame}{Bounding Boxes}
\centering
    \includegraphics[width=50mm]{./bbox.png}
